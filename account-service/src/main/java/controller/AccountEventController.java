...
public class AccountEventController {
    ...
    private static void ACEConnection() {
        try {
            ...
            Channel customerRegChannel = accountEventControllerConnection.createChannel();
    ...
    public static void listenCustomer() {
        try {
            ...
            accountEventControllerConnection = factory.newConnection();
            customerRegChannel = accountEventControllerConnection.createChannel();
            String queueName = customerRegChannel.queueDeclare().getQueue();
    ...
    static void listenMerchant() {
        try {
            ...
            factory.setHost(hostName);
            accountEventControllerConnection = factory.newConnection();
            Channel merchantRegChannel = accountEventControllerConnection.createChannel();
    ...
    static void listenAccountIDValidation() {
        try {
            ...
            factory.setHost(hostName);
            accountEventControllerConnection = factory.newConnection();
            Channel accountValidationChannel = accountEventControllerConnection.createChannel();
