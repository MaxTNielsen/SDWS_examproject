Feature: AccountManagement
    ...
    Scenario: Register a Customer in the Bank and in DTUPay
        Given the customer with CPR "445643-3452" and with the name "Pharles" "Sontana" and the balance 1000 kr
    ...
    Scenario: Register a Customer in the Bank and in DTUPay
        Given the customer with CPR "783423-2342" and with the name "Pharles" "Sontana" and the balance 1000 kr
        When the customer register in the bank
        When the customer register in DTUPay with his CPR as ID
        Then the customer has gotten an account in DTUPay

    Scenario:  Register a Merchant in the Bank and in DTUPay
        Given the merchant with CPR "190534-3350" and with the name "Hubert" "Claus" and the balance 2000 kr
