Feature: AccountManagement
    ...
    Scenario: Register a Customer in the Bank and in DTUPay
        Given the customer with CPR "701100-7172" and with the name "Pharles" "Sontana" and the balance 1000 kr
    ...
    Scenario:  Register a Merchant in the Bank and in DTUPay
        Given the merchant with CPR "234400-8080" and with the name "Hubert" "Claus" and the balance 1000 kr
